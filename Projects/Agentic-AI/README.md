...
Conversational agents, voice interfaces, and interactive learning systems. These projects explore multi-turn dialogue, tool use, agentic workflows, and AI-driven personalisation.

| Project | Description |
|---|---|
| [RootSeekers - Incident RCA Copilot](RootSeekers-Incident-RCA/) | LangGraph multi-agent RCA copilot: parallel evidence agents, root cause synthesis, chat assistant with safety guardrails |
